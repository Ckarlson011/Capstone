...
<div class="container mt-3">
    ...
    <img src="../../pub/IMG_1745.jpg" alt="Mountain against background of night scky with stars" style="max-width: 100%;height: auto;" class="col-12 mb-3 border border-white">
